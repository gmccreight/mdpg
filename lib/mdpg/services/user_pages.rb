...
class UserPages < Struct.new(:user)
  ...
  def duplicate_page(name, date, proposed_name: nil, text_options: nil)
    ...
    new_page = duplicator.duplicate(date, proposed_name: proposed_name, text_options: text_options)
